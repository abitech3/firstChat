...
class Page_Setting(models.Model):
	...
	admin_page_logo = models.ImageField( null=True , blank=True , upload_to = 'images' )
	login_page_logo = models.ImageField( null=True , blank=True , upload_to = 'images' )
	admin_login_image = models.ImageField( null=True , blank=True , upload_to = 'images' )
